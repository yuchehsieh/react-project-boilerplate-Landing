    ...
    <div className="header-full-header">
      <nav className="header-full-nav">
        <div className="header-full-container">
          <Link to="/home3" className="header-full-navlink large">
            Soft UI Design System
          </Link>
          <div className="header-full-menu">
            <Link to="/home3" className="header-full-navlink1 large">
              Home
            </Link>
            <Link to="/home3/profile" className="header-full-navlink2 large">
              Profile
            </Link>
            <Link to="/home3/coming-soon" className="header-full-navlink3 large">
              Coming Soon
            </Link>
          </div>
